...
const Configure = () => {
    ...
    const getConfigureData = async () => {
      try {
        const response = await axios.get(`https://quizwhizz.onrender.com/exam/exam/` + id.id,{ headers: { Authorization: `Bearer ${token}` } });
    ...
    const handleConfigure = (e) => {
      ...
      axios.patch(`https://quizwhizz.onrender.com/exam/` + id.id,exam,{ headers: { Authorization: `Bearer ${token}` } }).then((response) => {
        console.log(response.status);
        console.log(response.data);
