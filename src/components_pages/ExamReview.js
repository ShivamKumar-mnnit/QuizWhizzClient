...
const ExamReview = () => {
    ...
    const getUserInfos = async () => {
        console.log(id.id);
        const { data } = await axios.get(`https://quizwhizz.onrender.com/api/users/${id.id}`,{ headers: { Authorization: `Bearer ${token}` } });
        console.log(data)
        setUserData(data);
    }
    useEffect(() => {
    ...
    const getExamInfos = async () => {
        ...
        const { data } = await axios.get(`https://quizwhizz.onrender.com/userexams/exam/${id.eid}_${userData.firstName}`,{ headers: { Authorization: `Bearer ${token}` } });
        console.log(data)
...
const handleCapture = async () => {
    if (captureRef.current) {
      try {
        ...
        axios.put(`https://quizwhizz.onrender.com/userexams/status/${ueid}`, scorePayload)
          .then((response) => {
